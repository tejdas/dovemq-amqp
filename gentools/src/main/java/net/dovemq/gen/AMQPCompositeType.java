...
abstract class AMQPCompositeType implements AMQPType
{
    ...
    void generateClassFileForCompositeType(String dir) throws IOException
    {
        String fileName = String.format("%s/%s.java", dir, type);
        outputStream = new PrintWriter(new FileWriter(fileName, false));
        
        outputStream.println("/**");
        outputStream.println(" * This file was auto-generated by dovemq gentools.");
        outputStream.println(" * Do not modify.");
        outputStream.println(" */");
        
        try
        {
            generateClassFileBase(dir);            
            generateEncoder();                
            generateDecoder();
            outputStream.println("}");
        }
    ...
    private void generateClassFileBase(String dir) throws IOException
    {
