...
public class ConnectionSysTestMTClient {
    ...
    private static class TestConnector extends CAMQPTestTask implements
            Runnable {
        ...
        public void run() {
            ...
            CAMQPConnectionInterface connection = CAMQPConnectionFactory.createCAMQPConnection(brokerContainerId,
                    connectionProps);
            if (connection == null)
