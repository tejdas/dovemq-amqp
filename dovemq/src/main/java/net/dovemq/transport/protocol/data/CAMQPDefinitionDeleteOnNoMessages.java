...
public class CAMQPDefinitionDeleteOnNoMessages
{
    public static final String descriptor = "amqp:delete-on-no-messages:list";
    ...
    public static void encode(CAMQPEncoder encoder, CAMQPDefinitionDeleteOnNoMessages data)
    {
        long listSize = 1;
    ...
    public static CAMQPDefinitionDeleteOnNoMessages decode(CAMQPSyncDecoder decoder)
    {
        int formatCode;
        ...
        assert(listSize == 1);
        CAMQPDefinitionDeleteOnNoMessages data = new CAMQPDefinitionDeleteOnNoMessages();
