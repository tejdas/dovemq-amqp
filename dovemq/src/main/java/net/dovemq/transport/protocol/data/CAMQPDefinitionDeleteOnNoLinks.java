...
public class CAMQPDefinitionDeleteOnNoLinks
{
    public static final String descriptor = "amqp:delete-on-no-links:list";
    ...
    public static void encode(CAMQPEncoder encoder, CAMQPDefinitionDeleteOnNoLinks data)
    {
        long listSize = 1;
    ...
    public static CAMQPDefinitionDeleteOnNoLinks decode(CAMQPSyncDecoder decoder)
    {
        int formatCode;
        ...
        assert(listSize == 1);
        CAMQPDefinitionDeleteOnNoLinks data = new CAMQPDefinitionDeleteOnNoLinks();
