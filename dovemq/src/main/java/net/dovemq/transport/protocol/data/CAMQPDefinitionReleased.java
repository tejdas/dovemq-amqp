...
public class CAMQPDefinitionReleased
{
    public static final String descriptor = "amqp:released:list";
    ...
    public static CAMQPDefinitionReleased decode(CAMQPSyncDecoder decoder)
    {
        int formatCode;
        ...
        assert(listSize == 1);
        CAMQPDefinitionReleased data = new CAMQPDefinitionReleased();
