...
public class CAMQPDefinitionDeleteOnClose
{
    public static final String descriptor = "amqp:delete-on-close:list";
    ...
    public static void encode(CAMQPEncoder encoder, CAMQPDefinitionDeleteOnClose data)
    {
        long listSize = 1;
    ...
    public static CAMQPDefinitionDeleteOnClose decode(CAMQPSyncDecoder decoder)
    {
        int formatCode;
        ...
        assert(listSize == 1);
        CAMQPDefinitionDeleteOnClose data = new CAMQPDefinitionDeleteOnClose();
